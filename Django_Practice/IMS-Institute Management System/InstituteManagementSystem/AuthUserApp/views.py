...
def teacherListPage(request):
    ...
    return render(request, 'teacher/teacherList.html',{'teacherInfo':teacherInfo})
...
def studentListPage(request):
    ...
    return render(request, 'student/studentList.html',{'studentInfo':studentInfo})
...
def pendingStudentRegPage(request):
    ...
    return render(request, 'pending_student/pendingStudentReg.html')

def pendingPage(request):
    pendingStudent = PendingModeel.objects.all()
    return render(request, 'pending_student/pending.html',{'pendingStudent':pendingStudent})
